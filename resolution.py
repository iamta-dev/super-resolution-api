...
def super_resolution(imgBase64):

    # img_path = 'test22.jpg'
    img_path = utils.getI420FromBase64(imgBase64)
    ...
    base64_message=''
    with open('output_face.jpg', 'rb') as binary_file:
        binary_file_data = binary_file.read()
        base64_encoded_data = base64.b64encode(binary_file_data)
        base64_message = 'data:image/png;base64,'+base64_encoded_data.decode('utf-8')
